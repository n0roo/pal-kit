...
func runInit(cmd *cobra.Command, args []string) error {
	...
	// DB 초기화
	dbPath := filepath.Join(baseDir, "palkit.db")
    ...
    "SessionStart": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "palkit hook session-start"
          }
        ]
      }
    ],
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "palkit hook pre-tool-use"
          }
        ]
      }
    ],
    ...
    "PreCompact": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "palkit hook pre-compact"
          }
        ]
      }
    ]
